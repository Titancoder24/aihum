...
export interface ModeSelectorProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onSelect' | 'onChange'> {
    ...
    return (
      ...
      >
        {modes.map((mode) => {
          ...
          const isSelected = mode.name === currentValue;
